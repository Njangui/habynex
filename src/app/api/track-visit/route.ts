...
// Enregistre une vue de page (visiteur anonyme ou connecté) avec
// géolocalisation IP (pays/ville) résolue côté serveur via les
// headers Vercel — le client ne peut pas connaître son IP/géoloc.
// ================================================================
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Si la page visitée est une fiche annonce (/bien/[slug]), on résout
    // l'id de l'annonce pour permettre les stats "vues par annonce"
